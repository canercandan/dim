...
IF(EO_FIND_COMPONENTS)
  ...
  ELSE(NOT EO_USE_PYEO)
    SET(EO_LIBRARIES_TO_FIND ${EO_LIBRARIES_TO_FIND} PyEO_shared)
  ENDIF(NOT EO_USE_PYEO)

  IF(NOT EO_USE_ES)
    SET(EO_DONT_USE_ES 1)
  ELSE(NOT EO_USE_ES)
    SET(EO_LIBRARIES_TO_FIND ${EO_LIBRARIES_TO_FIND} es_shared)
  ENDIF(NOT EO_USE_ES)

  IF(NOT EO_USE_GA)
    SET(EO_DONT_USE_GA 1)
  ELSE(NOT EO_USE_GA)
    SET(EO_LIBRARIES_TO_FIND ga_shared ${EO_LIBRARIES_TO_FIND})
  ENDIF(NOT EO_USE_GA)

  IF(NOT EO_USE_CMA)
    SET(EO_DONT_USE_CMA 1)
  ELSE(NOT EO_USE_CMA)
    SET(EO_LIBRARIES_TO_FIND ${EO_LIBRARIES_TO_FIND} cma_shared)
  ENDIF(NOT EO_USE_CMA)

  IF(NOT EO_USE_MPI)
    SET(EO_DONT_USE_MPI 1)
  ELSE(NOT EO_USE_MPI)
    SET(EO_LIBRARIES_TO_FIND ${EO_LIBRARIES_TO_FIND} eompi_shared)
  ENDIF(NOT EO_USE_MPI)

  IF(NOT EO_USE_SERIAL)
    SET(EO_DONT_USE_SERIAL 1)
  ELSE(NOT EO_USE_SERIAL)
    SET(EO_LIBRARIES_TO_FIND ${EO_LIBRARIES_TO_FIND} eoserial_shared)
