...
#ifndef _DO_MAKE_GA_DETAIL_GENOTYPE_H_
#define _DO_MAKE_GA_DETAIL_GENOTYPE_H_
...
namespace dim
{
	...
	namespace detail
	{
	     ...
	     *
	     * It returns an eoInit<Bit<FitT> > tha can later be used to initialize
	     ...
	     */
	    template <class EOT>
	    eoInit<EOT> & genotype(eoParser& _parser, eoState& _state, EOT, float _bias=0.5)
	    {
