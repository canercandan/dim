...
#include <dim/do_make/detail/pop.h>
...
namespace dim
{
	...
	// Init POP
	///////////
	core::Pop<core::Bit<double> >&  pop(eoParser& _parser, eoState& _state, eoInit<core::Bit<double> > & _init)
	{
	    return detail::pop(_parser, _state, _init);
	}

	core::Pop<core::Bit<eoMinimizingFitness> >&  pop(eoParser& _parser, eoState& _state, eoInit<core::Bit<eoMinimizingFitness> > & _init)
	{
	    return detail::pop(_parser, _state, _init);
	}
