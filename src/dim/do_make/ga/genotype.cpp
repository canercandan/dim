...
namespace dim
{
	...
	eoInit<core::Bit<double> > & genotype(eoParser& _parser, eoState& _state, core::Bit<double> _eo, float _bias)
	{
	    return detail::genotype(_parser, _state, _eo, _bias);
	}

	eoInit<core::Bit<eoMinimizingFitness> > & genotype(eoParser& _parser, eoState& _state, core::Bit<eoMinimizingFitness> _eo, float _bias)
	{
	    return detail::genotype(_parser, _state, _eo, _bias);
	}
