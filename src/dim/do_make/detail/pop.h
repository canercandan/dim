...
#ifndef _DO_MAKE_DETAIL_POP_H_
#define _DO_MAKE_DETAIL_POP_H_
...
namespace dim
{
	...
	namespace detail
	{
	     ...
	     */
	    template <class EOT>
	    core::Pop<EOT>&  pop(eoParser & _parser, eoState& _state, eoInit<EOT> & _init)
	    {
		// random seed
		...
		core::Pop<EOT>& pop = _state.takeOwnership(core::Pop<EOT>());
