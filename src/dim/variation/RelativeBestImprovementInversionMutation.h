...
#ifndef _VARIATION_RELATIVEBESTIMPROVEMENTINVERSIONMUTATION_H_
#define _VARIATION_RELATIVEBESTIMPROVEMENTINVERSIONMUTATION_H_
...
namespace dim
{
	...
	class RelativeBestImprovementInversionMutation : public eoMonOp<EOT>
	{
	public:
	    /// The class name.
	    virtual std::string className() const { return "RelativeBestImprovementInversionMutation"; }
...
#endif /* _VARIATION_RELATIVEBESTIMPROVEMENTINVERSIONMUTATION_H_ */
